...
- 🌱 **Skills:** - **Frontend Development:** HTML, CSS, and JavaScript  
  - **AI Enthusiast:** Exploring AI tools and technologies  
- 💡 **AI Tools I've Used:** - **ChatGPT**: For generating ideas and solving problems  
...
### 1. **EcoWatch AI**
- A **Geospatial AI** platform built to monitor and visualize environmental changes in real-time.
- Focuses on sustainability and data-driven insights.

### 2. **Crediwise**
- A smart **FinTech** loan recommendation web app designed to simplify financial decision-making.
- Built to provide personalized user insights based on financial data.

### 3. **Weather Widget**
- A weather application built with **HTML**, **CSS**, and **JavaScript**.
- Uses the **OpenWeather API** to fetch real-time weather data with AI-powered suggestions.
...
### 5. **Smart To-Do List**
- A sleek productivity tool to manage daily tasks and enhance workflow efficiency.
...
- **C++**: Strengthening my logical and competitive programming foundation.
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=tanmaystar-512&theme=radical" alt="Contribution Graph" />
</p>
